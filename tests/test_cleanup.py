...
class TestSecretPatterns:
    ...
    def test_openai_key_pattern(self):
        ...
        import re
        pattern = re.compile(cleanup.SECRET_PATTERNS["OpenAI/Anthropic API Keys"])
    ...
    def test_github_token_pattern(self):
        ...
        import re
        pattern = re.compile(cleanup.SECRET_PATTERNS["GitHub Tokens"])
    ...
    def test_aws_key_pattern(self):
        ...
        import re
        pattern = re.compile(cleanup.SECRET_PATTERNS["AWS Keys"])
    ...
    def test_posthog_key_pattern(self):
        ...
        import re
        pattern = re.compile(cleanup.SECRET_PATTERNS["PostHog Keys"])
